...
export default (props) => {
    ...
    return (
        <>
            <div className='flex flex-[2] flex-col p-2 lg:flex-row justify-between gap-[1rem] lg:gap-[5rem]'>
                <section id='box-items' className='flex gap-1 sm:gap-2 items-center justify-center '>
                    <div className='p-2 border border-wmsGrey w-[9rem] h-[9rem] sm:w-[200px] sm:h-[200px] rounded-lg shadow-xl'>
                        <img id='img-items' alt="Item" />
                    </div>
                ...
                <section id='checkout-true' className='text-sm hidden sm:text-lg flex-col justify-between min-h-[200px]'>
                    ...
                    <footer>
                        ...
                        <button id='confirmar-t' className='p-2 rounded hidden bg-green-500' type='button' onClick={
                            () => {
                ...
                <section id='box-checkout' className='flex gap-1 sm:gap-2 items-center justify-center'>
                    <div className='border-wmsGrey flex flex-col justify-between text-sm sm:text-md lg:text-xl border w-[22rem] sm:w-[30rem] lg:w-[25rem] h-[15rem] lg:h-[20rem] rounded-lg shadow-xl '>
                        <header className='font-semibold h-[15%] border-b p-2  border-wmsGrey'>
                            <h2>Leituras</h2>
                        </header>
                        <main className='overflow-y-scroll h-[70%] '>
                            <ul id="ul-checkout">
            ...
            <div id='form-area' className='flex w-full pl-[2.5rem] pr-[2.5rem] sm:pl-[4rem] sm:pr-[4rem] lg:p-2 lg:w-[50%] items-center justify-between gap-2 sm:gap-[2rem] '>
