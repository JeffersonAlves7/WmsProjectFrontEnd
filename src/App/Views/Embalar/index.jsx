...
function Scanner() {
    return (
        <input type="text" name="listaDePedidosInput" id="input_lista" placeholder="Escanear ou inserir o ID da Lista de Pedido" className="border pt-4 pb-4 pl-4 pr-4 rounded-md border-wmsLightPink outline-none text-2xl w-[35rem]" />
    )
}
    ...
    return (
        <>
            ...
            <main className="flex gap-10 items-center">
                <Scanner />
                <Button type="button" text="Enviar" fn={async () => {
