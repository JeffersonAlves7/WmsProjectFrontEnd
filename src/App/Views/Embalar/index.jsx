...
function Scanner() {
    return (
        <input onKeyDown={({ key }) => {
            if (key !== "Enter") return;
            enviar()
        }} type="text" name="listaDePedidosInput" autoFocus={true} id="input_lista" placeholder="Escanear ou inserir o ID da Lista de Pedido" className="border pt-4 pb-4 pl-4 pr-4 rounded-md border-wmsLightPink outline-none text-2xl w-[35rem]" />
    )
}
