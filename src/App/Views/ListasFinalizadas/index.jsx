            ...
            if (situacao.toLowerCase() === "emaberto") {
                return (
                    <div className='flex gap-4 text-sm flex-col'>
                        <a href={window.location.origin + "/listadecoleta?id=" + id} target="_blank" className='wmsButton p-1 sm:p-2'>Imprimir lista com pedidos</a>
                        <a href={window.location.origin + "/listadeseparacao?id=" + id} target="_blank" className='wmsButton p-1 sm:p-2'>Imprimir lista com produtos</a>
                    </div>
                )
            }
            return <p>{situacao}</p>
